...
DISE.components = {
  ...
  /**
   * 화면 전용 편집 UI 전체 — 문서 양식/발신인 드롭다운 + 시행일자 날짜
   * 입력칸 + 도움말(?) 버튼·팝업 + 인쇄 버튼, 그 아래 모바일/인쇄 보기
   * 토글 자리, 서식 도구모음
      ...
      '<div class="toolbar no-print">' +
        '<div class="toolbar-card">' +
          '<div class="toolbar-card-title">' +
            ...
            '</span>' +
            // 시행일자 입력칸 — 기본값(오늘 날짜)과 문서 상단 표시(#effDate)
            // 갱신은 shared/scripts/editor.js 섹션 13이 처리합니다. 모든
            // 문서 템플릿 공통이라 여기 한 곳에만 마크업을 두면 됩니다.
            '<span class="eff-date-field">' +
              '<label for="effDateInput">시행일자</label>' +
              '<input type="date" id="effDateInput">' +
            '</span>' +
        ...
        '<div class="help-modal no-print" id="helpModal" hidden>' +
          '<div class="help-modal-card">' +
            ...
            '<h2>사용법 안내</h2>' +
            '<p>점선 테두리가 있는 <b>문서번호 · 제목 · 수신처 · 본문</b> 영역은 브라우저에서 바로 클릭해서 입력할 수 있습니다. 대괄호([ ])로 된 안내 문구는 클릭하면 자동으로 전체 선택되어 바로 타이핑하면 덮어써집니다. 시행일자는 오늘 날짜로 자동 채워지고, 상단 발신인 옆 날짜 입력칸에서 다른 날짜로 바꿀 수 있습니다.</p>' +
